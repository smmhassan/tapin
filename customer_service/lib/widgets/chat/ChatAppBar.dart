...
import 'package:customer_service/widgets/RoundImage.dart';
...
class ChatAppBar extends AppBar{
  ...
  ChatAppBar(BuildContext context, this.user, this.image, this.chatName, {this.bottom}) :super(
    bottom: bottom,
    backgroundColor: Theme.of(context).accentColor,
    iconTheme: IconThemeData(color: Theme.of(context).canvasColor),
    //title: headerLogo,
    //centerTitle: true,
    title: !(MediaQuery.of(context).size.width > wideBreakPoint) ? ChatInfo(image: image,chatName: chatName) : PreferredSize(
