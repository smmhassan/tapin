...
class _UserOrganizationState extends State<UserOrganization> {
  ...
  Widget build(BuildContext context) {
    final String organizationId = (ModalRoute.of(context)!.settings.arguments as UserOrganizationArguments).id;
                    ...
                    Query(
                        ...
                        builder: (result, {refetch, fetchMore}) {
                          ...
                          if (result.data?["organization"] != null) {
                            ImageProvider dp = NetworkImage(result.data?["organization"]["logo"]['url']);
